...
// return (
//   <div
//     className={`border p-2 bg-white h-full w-full my-2  `}
//   >
//     <div className="flex h-full w-full flex-col ">
//       <div className="flex p-4 justify-between w-full items-center rounded-md">
//         <h1 className="flex text-xl">My Cart</h1>
